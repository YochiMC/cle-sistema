...
<head>
    ...
    <title>Realizar inscripcion</title>
    ...
    <link rel="stylesheet" href="{{ asset('css/realizarRegistro.css') }}">
...
<body>
    ...
    <section class="horarioNota">
        <div class="nota">
            <input type="checkbox" id="ch">
            <label for="ch" class="notaDesp">NOTA.</label>
            <div class="content">
                Recuerda de llenar toda tu información personal para tener una mejor experiencia en la plataforma.
            </div>
        </div>

        <div class="horario">
            <h3>Elige un horario para el Placement Test</h3>
            <div class="formulario-opciones">
                <form>
                    <label class="opcionesM">
                        <input type="radio" name="opcion" value="opcion1" class="opciones"> 25 de Agosto del 2024 a las 12:00
                    </label>
                    <br>
                    <label class="opcionesM">
                        <input type="radio" name="opcion" value="opcion2" class="opciones"> 25 de Agosto del 2024 a las 15:00
                    </label>
                    <br>
                    <label class="opcionesM">
                        <input type="radio" name="opcion" value="opcion3" class="opciones"> 27 de Agosto del 2024 a las 12:00
                    </label>
                    <br>
                    <label class="opcionesM">
                        <input type="radio" name="opcion" value="opcion2" class="opciones"> 25 de Agosto del 2024 a las 15:00
