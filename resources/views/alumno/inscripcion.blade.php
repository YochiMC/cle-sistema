...
<body>
    ...
    <section class="encabezadoIM">
        <a href="{{ route('alumno.secciones') }}" class="edulangA">
            <h1 class="edulang">
        ...
        <div class="apartados">
            ...
            <div class="icons-wrapper">
                <a href="#" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                    <svg xmlns="http://www.w3.org/2000/svg" class="cerrarsesion" width="20" height="20"
    ...
    <nav class="menu" id="menu">
        ...
        <a href="{{ route('alumno.info_personal') }}">
            <svg xmlns="http://www.w3.org/2000/svg" class="iconoMenu" width="16" height="16" fill="currentColor"
                class="bi bi-box-arrow-right" viewBox="0 0 16 16">
        ...
        <form action="{{ route('logout') }}" method="POST" style="display: inline;">
            @csrf
            <button type="submit" class="iconoMenu" style="background: none; border: none; cursor: pointer;">
    ...
    <section class="reciboTabla">
        <div class="SubirArchivo">
            <h1 class="titulos">¡Carga tu recibo de pago aquí!</h1>
            <label for="file-upload" class="btnsubirConfirmar">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="subir-icon" viewBox="0 0 16 16">
        ...
        <div class="tablaArchivos">
            <div class="tabla">
                <table border="1">
                    <thead>
                        <tr>
                            <th colspan="4">Archivos cargados.</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            <td><img src="../img/pdf.png" alt="" class="imgPdf"></td>
                            <td>Recibo de pago</td>
                            <td><button class="btnsubirConfirmar"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="check-icon" viewBox="0 0 16 16">
                                <path d="M10.97 4.97a.75.75 0 0 1 1.07 1.05l-3.99 4.99a.75.75 0 0 1-1.08.02L4.324 8.384a.75.75 0 1 1 1.06-1.06l2.094 2.093 3.473-4.425z"/>
                              </svg></button></td>
                            <td><button class="btnEliminar"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="delete-icon" viewBox="0 0 16 16">
