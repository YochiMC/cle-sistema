...
<body>
    ...
    <section class="tablaCalif">
        <div class="tituloBoton">
            <h1>Kardex del alumno.</h1>
            <button class="btnDescargar"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="descargar_icono" viewBox="0 0 16 16">
