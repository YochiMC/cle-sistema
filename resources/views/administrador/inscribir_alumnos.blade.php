                 ...
                 <td>
                     <div class="gestionar" @if ($alumno->inscrito == 1) style="display: none;" @endif>
                         <form method="POST" action="{{ route('admin.inscripciones.create', [$alumno->id_alumno, $grupo->id_curso]) }}">
                             @csrf
                             <button type="submit" class="btn btn-warning btn-sm"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-square" viewBox="0 0 16 16">
                     ...
                     <div class="gestionar" @if ($alumno->inscrito == 0) style="display: none;" @endif>
                         <form method="POST" action="{{ route('admin.inscripciones.delete', [$alumno->id_alumno, $grupo->id_curso]) }}">
                             @csrf
                             @method('DELETE')
                             <button type="submit" class="btn btn-danger btn-sm">
