...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/informacionAlumnados.css') }}">
...
<body>
    ...
    <div class="contenedor_prin">
        <section class="alumnosT">
            <div class="unAlumno">
                <div>
                    <h3>Juan Diego Espinoza López</h3>
                    <p>20202020</p>
                    <p>Ing. Sistemas computacionales</p>
                </div>
                <div>
                    <a href="InformacionAlumno.html" class="btnInfoAlumno">Acceder →</a>
                    <br>
                    <button class="verComprobante">Comprobante.</button>
                </div>
            </div>
            <div class="unAlumno">
                <div>
