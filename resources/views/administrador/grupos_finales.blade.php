...
<head>
    ...
    <title>Grupos finales</title>
    <link rel="shortcut icon" href="{{ asset('resources/icons/icono.png') }}" type="image/x-icon">
    <link rel="stylesheet" href="{{ asset('css/gruposFinales.css') }}">
    <link rel="stylesheet" href="{{ asset('css/gruposFinalesM.css') }}">
    ...
    <script src="../scripts/gruposFinales.js"></script>
</head>
...
<body>
    ...
    <section class="encabezadoIM">
        <a href="{{ route('admin.secciones') }}" class="edulangA">
            <h1 class="edulang">
        ...
        <div class="apartados">
            <div class="icons-wrapper">
                <svg xmlns="http://www.w3.org/2000/svg" class="icons_barra" width="20" height="20"
    ...
    <div class="contenedor_prin">
        <section class="gruposTF">
            <div class="tituloBoton">
                <h1>Grupos finales</h1>
                <button id="modifyBtn"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
            ...
            <div class="tabla">
                <table border="1">
                    ...
                    <tbody id="table-body">
                        <tr>
                            <td>A</td>
                            <td>Vitaly Lavrenko</td>
                            <td>Aula</td>
                            <td>12:15 - 13:55</td>
                            <td><button class="delete-btn"><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                        height="16" fill="currentColor" class="bi bi-eraser" viewBox="0 0 16 16">
                                        <path
