                    ...
                    @foreach ($data as $alumno)
                        <tr>
                            ...
                            <td>
                                <div class="gestionar">
                                    <form method="GET"
                                        action="{{ route('admin.actualiza_usuario', $alumno->id_usuario) }}">
                                        @csrf
                                    ...
                                    <form action="{{ route('admin.usuarios.delete', $alumno->id_usuario) }}"
                        ...
                        <tr>
                            ...
                            <td class="infor">
                                <div class="gestionar">
                                    ...
                                    <form action="{{ route('admin.usuarios.delete', $docente->id_usuario) }}"
                                        method="POST" style="display:inline;">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="btn btn-danger btn-sm"
